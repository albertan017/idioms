...
try:
    ...
    import idioms.data.idastubs.idaapi as ida

from json import dumps

# Huge hack to get importing to work with the decompiler
try:
    from idioms.data.types import TypeLib, TypeLibCodec, TypeInfo
    from idioms.data.variable import Variable
except ImportError:
    from types import TypeLib, TypeLibCodec, TypeInfo
